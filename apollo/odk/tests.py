...
class ODKTest(TestCase):
    ...
    def _setup_fixtures(self):
        ...
        start = current_timestamp.replace(hour=0, minute=0, second=0, microsecond=0)
        end = current_timestamp.replace(hour=23, minute=59, second=59, microsecond=999999)
        ...
        self._location_set_1 = models.LocationSet(name='Location Set 1', deployment=self._deployment)
        self._location_set_2 = models.LocationSet(name='Location Set 2', deployment=self._deployment)

        # self._participant_set_1 = models.ParticipantSet(name='Participant Set 1', deployment=self._deployment)
        # self._participant_set_2 = models.ParticipantSet(name='Participant Set 2', deployment=self._deployment)

        self._form1 = models.Form(name='Form 1', prefix='XA', deployment=self._deployment, form_type='CHECKLIST', form_set=self._form_set_1)
        self._form2 = models.Form(name='Form 2', prefix='XB', deployment=self._deployment, form_type='CHECKLIST', form_set=self._form_set_1)
        self._form3 = models.Form(name='Form 3', prefix='XC', deployment=self._deployment, form_type='CHECKLIST', form_set=self._form_set_2)
        ...
        db.session.add_all([
            ...
            self._form2,
            self._form3,
            # self._participant_set_1,
            # self._participant_set_2,
            self._event1,
            self._event2,
            self._event3,
        ])

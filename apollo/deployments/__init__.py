...
class EventsService(Service):
    ...
    def find(self, **kwargs):
        ...
        if current_user.is_authenticated():
            kwargs[u'pk__in'] = [event.pk for event in filter(
                    lambda f: Permission(ItemNeed(u'access_event', f, u'object'),
    ...
    def default(self):
        ...
        return self.get_or_create(name=u'Default')

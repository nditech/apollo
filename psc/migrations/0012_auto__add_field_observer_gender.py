...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Observer.gender'
        db.add_column('psc_observer', 'gender', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Observer.gender'
        db.delete_column('psc_observer', 'gender')

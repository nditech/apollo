...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Sample'
        db.create_table('psc_sample', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sample', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sample', to=orm['psc.RegistrationCenter'])),
        ))
        db.send_create_signal('psc', ['Sample'])


    def backwards(self, orm):
        
        # Deleting model 'Sample'
        db.delete_table('psc_sample')

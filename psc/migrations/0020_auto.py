...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'EDAYChecklistAuditLogEntry', fields ['checklist_index']
        db.create_index('psc_edaychecklistauditlogentry', ['checklist_index'])

        # Adding index on 'EDAYChecklist', fields ['checklist_index']
        db.create_index('psc_edaychecklist', ['checklist_index'])


    def backwards(self, orm):
        
        # Removing index on 'EDAYChecklist', fields ['checklist_index']
        db.delete_index('psc_edaychecklist', ['checklist_index'])

        # Removing index on 'EDAYChecklistAuditLogEntry', fields ['checklist_index']
        db.delete_index('psc_edaychecklistauditlogentry', ['checklist_index'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RegistrationCenter.location_ptr'
        db.delete_column('psc_registrationcenter', 'location_ptr_id')

        # Adding field 'RegistrationCenter.id'
        db.add_column('psc_registrationcenter', 'id', self.gf('django.db.models.fields.AutoField')(default=None, primary_key=True), keep_default=False)

        # Adding field 'RegistrationCenter.parent'
        db.add_column('psc_registrationcenter', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['psc.LGA'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'RegistrationCenter.location_ptr'
        db.add_column('psc_registrationcenter', 'location_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['locations.Location'], unique=True, primary_key=True), keep_default=False)

        # Deleting field 'RegistrationCenter.id'
        db.delete_column('psc_registrationcenter', 'id')

        # Deleting field 'RegistrationCenter.parent'
        db.delete_column('psc_registrationcenter', 'parent_id')

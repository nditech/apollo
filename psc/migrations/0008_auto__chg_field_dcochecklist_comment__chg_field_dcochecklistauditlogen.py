...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DCOChecklist.comment'
        db.alter_column('psc_dcochecklist', 'comment', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'DCOChecklistAuditLogEntry.comment'
        db.alter_column('psc_dcochecklistauditlogentry', 'comment', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'VRIncident.comment'
        db.alter_column('psc_vrincident', 'comment', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'VRIncidentAuditLogEntry.comment'
        db.alter_column('psc_vrincidentauditlogentry', 'comment', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'DCOIncidentAuditLogEntry.comment'
        db.alter_column('psc_dcoincidentauditlogentry', 'comment', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'DCOIncident.comment'
        db.alter_column('psc_dcoincident', 'comment', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'DCOChecklist.comment'
        db.alter_column('psc_dcochecklist', 'comment', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'DCOChecklistAuditLogEntry.comment'
        db.alter_column('psc_dcochecklistauditlogentry', 'comment', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'VRIncident.comment'
        db.alter_column('psc_vrincident', 'comment', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'VRIncidentAuditLogEntry.comment'
        db.alter_column('psc_vrincidentauditlogentry', 'comment', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'DCOIncidentAuditLogEntry.comment'
        db.alter_column('psc_dcoincidentauditlogentry', 'comment', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'DCOIncident.comment'
        db.alter_column('psc_dcoincident', 'comment', self.gf('django.db.models.fields.CharField')(max_length=100))

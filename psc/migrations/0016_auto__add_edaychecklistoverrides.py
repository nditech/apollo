...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EDAYChecklistOverrides'
        db.create_table('psc_edaychecklistoverrides', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('field', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('checklist', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['psc.EDAYChecklist'])),
        ))
        db.send_create_signal('psc', ['EDAYChecklistOverrides'])


    def backwards(self, orm):
        
        # Deleting model 'EDAYChecklistOverrides'
        db.delete_table('psc_edaychecklistoverrides')

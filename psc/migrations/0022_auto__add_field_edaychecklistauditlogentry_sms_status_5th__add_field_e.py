...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EDAYChecklistAuditLogEntry.sms_status_5th'
        db.add_column('psc_edaychecklistauditlogentry', 'sms_status_5th', self.gf('django.db.models.fields.PositiveIntegerField')(default=3, blank=True), keep_default=False)

        # Adding field 'EDAYChecklist.sms_status_5th'
        db.add_column('psc_edaychecklist', 'sms_status_5th', self.gf('django.db.models.fields.PositiveIntegerField')(default=3, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EDAYChecklistAuditLogEntry.sms_status_5th'
        db.delete_column('psc_edaychecklistauditlogentry', 'sms_status_5th')

        # Deleting field 'EDAYChecklist.sms_status_5th'
        db.delete_column('psc_edaychecklist', 'sms_status_5th')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DCOChecklist.sms_serial'
        db.delete_column('psc_dcochecklist', 'sms_serial')

        # Deleting field 'DCOChecklistAuditLogEntry.sms_serial'
        db.delete_column('psc_dcochecklistauditlogentry', 'sms_serial')


    def backwards(self, orm):
        
        # Adding field 'DCOChecklist.sms_serial'
        db.add_column('psc_dcochecklist', 'sms_serial', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'DCOChecklistAuditLogEntry.sms_serial'
        db.add_column('psc_dcochecklistauditlogentry', 'sms_serial', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Observer.zone'
        db.add_column('psc_observer', 'zone', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['psc.Zone'], null=True, blank=True), keep_default=False)

        # Adding field 'Observer.state'
        db.add_column('psc_observer', 'state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['psc.State'], null=True, blank=True), keep_default=False)

        # Adding field 'Observer.district'
        db.add_column('psc_observer', 'district', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['psc.District'], null=True, blank=True), keep_default=False)

        # Adding field 'Observer.lga'
        db.add_column('psc_observer', 'lga', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['psc.LGA'], null=True, blank=True), keep_default=False)

        # Adding field 'Observer.ps'
        db.add_column('psc_observer', 'ps', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['psc.RegistrationCenter'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Observer.zone'
        db.delete_column('psc_observer', 'zone_id')

        # Deleting field 'Observer.state'
        db.delete_column('psc_observer', 'state_id')

        # Deleting field 'Observer.district'
        db.delete_column('psc_observer', 'district_id')

        # Deleting field 'Observer.lga'
        db.delete_column('psc_observer', 'lga_id')

        # Deleting field 'Observer.ps'
        db.delete_column('psc_observer', 'ps_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contesting.state'
        db.alter_column('psc_contesting', 'state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['psc.State'], null=True))

        # Adding field 'EDAYChecklistAuditLogEntry.last_updated'
        db.add_column('psc_edaychecklistauditlogentry', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True), keep_default=False)

        # Adding field 'EDAYChecklist.last_updated'
        db.add_column('psc_edaychecklist', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Contesting.state'
        db.alter_column('psc_contesting', 'state_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['psc.State']))

        # Deleting field 'EDAYChecklistAuditLogEntry.last_updated'
        db.delete_column('psc_edaychecklistauditlogentry', 'last_updated')

        # Deleting field 'EDAYChecklist.last_updated'
        db.delete_column('psc_edaychecklist', 'last_updated')
    ...
    models = {
        ...
        'psc.registrationcenter': {
            'Meta': {'ordering': "['name']", 'object_name': 'RegistrationCenter'},

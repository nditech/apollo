...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EDAYIncident.date'
        db.alter_column('psc_edayincident', 'date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'EDAYIncidentAuditLogEntry.date'
        db.alter_column('psc_edayincidentauditlogentry', 'date', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'EDAYIncident.date'
        db.alter_column('psc_edayincident', 'date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'EDAYIncidentAuditLogEntry.date'
        db.alter_column('psc_edayincidentauditlogentry', 'date', self.gf('django.db.models.fields.DateField')())

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VRChecklist.comment'
        db.alter_column('psc_vrchecklist', 'comment', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'VRChecklistAuditLogEntry.comment'
        db.alter_column('psc_vrchecklistauditlogentry', 'comment', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'VRChecklist.comment'
        db.alter_column('psc_vrchecklist', 'comment', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'VRChecklistAuditLogEntry.comment'
        db.alter_column('psc_vrchecklistauditlogentry', 'comment', self.gf('django.db.models.fields.CharField')(max_length=100))

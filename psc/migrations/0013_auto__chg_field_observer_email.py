...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Observer.email'
        db.alter_column('psc_observer', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))


    def backwards(self, orm):
        
        # Changing field 'Observer.email'
        db.alter_column('psc_observer', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75))

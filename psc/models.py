...
class VRChecklist(models.Model):
    ...
    B = models.PositiveSmallIntegerField(blank=True, choices=YES_NO, help_text='Were you permitted to observe at the registration centre? (tick Yes or No) (If not permitted to observe complete a critical incident form and immediately report)')
    ...
    D1 = models.NullBooleanField(blank=True, help_text='Did the registration centre have a complete and functioning Direct Data Capture (DDC) system (tick all that apply)')
    D2 = models.NullBooleanField(blank=True)
    D3 = models.NullBooleanField(blank=True)
    D4 = models.NullBooleanField(blank=True)
    E1 = models.NullBooleanField(blank=True, help_text='Was the registration centre missing any of the following materials? (tick all that apply)')
    ...
    G = models.PositiveSmallIntegerField(blank=True, choices=YES_NO, help_text='Were any security agents present at the registration centre? (tick Yes or No)')
    ...
    P = models.IntegerField(blank=True, null=True, choices=TURNOVER, help_text='Were successful registrants issued with temporary voter''s cards? (tick the one that applies best)')
    ...
    T = models.PositiveSmallIntegerField(blank=True, choices=YES_NO, help_text='Did the Direct Data Capture (DDC) system properly function throughout the day? (tick Yes or No)')
    U = models.PositiveSmallIntegerField(blank=True, choices=YES_NO, help_text='Did the registration centre run out of materials during the day? (tick Yes or No)')
    V = models.PositiveSmallIntegerField(blank=True, choices=YES_NO, help_text='Did the registration centre remain open until 5 pm? (tick Yes or No)')
    W = models.PositiveSmallIntegerField(blank=True, choices=YES_NO, help_text='Did anyone attempt to disrupt voter registration at the centre? (tick Yes or No)')
    X = models.PositiveSmallIntegerField(blank=True, choices=YES_NO, help_text='Did anyone attempt to intimidate or harass people in or around the centre? (tick Yes or No)')
...
class DCOChecklist(models.Model):
    ...
    observer = models.ForeignKey(Observer)
    date = models.DateField()
    A = models.PositiveSmallIntegerField(blank=True, choices=YES_NO, help_text='Was the registration centre open? (tick Yes or No) (If not permitted to observe complete a critical incident form and immediately report)')
    B = models.PositiveSmallIntegerField(blank=True, null=True, choices=YES_NO, help_text='Were you permitted to observe at the registration centre? (tick Yes or No) (If not permitted to observe complete a critical incident form and immediately report)')
    C = models.IntegerField(blank=True, null=True, help_text='How many registration officers were at the registration centre? (enter number)')
    D = models.PositiveSmallIntegerField(blank=True, choices=YES_NO, help_text='Was the Preliminary Register of Voters (PRV) posted in a visible place for public scrutiny? (tick Yes or No)(If the PRV was not posted complete a critical incident form and immediately report)')
    E = models.PositiveSmallIntegerField(blank=True, choices=YES_NO, help_text='Did the election officials provide any instructions to people about how to make a claim or objection? (tick Yes or No)')
    F1 = models.NullBooleanField(blank=True,  help_text='Were any of the following forms missing? (tick all that apply)')
    ...
    H = models.PositiveSmallIntegerField(blank=True, null=True, choices=YES_NO, help_text='Were any security agents present at the registration centre? (tick Yes or No)')
    ...
    M = models.PositiveSmallIntegerField(blank=True, choices=YES_NO, help_text='Was anyone prevented from scrutinizing the Preliminary Register of Voters (PRV)? (tick Yes or No)')
    N = models.PositiveSmallIntegerField(blank=True, null=True, choices=YES_NO, help_text='Was anyone prevented from filing a Claim to have his/her name added to or corrected on the Preliminary Register of Voters (PRV) (tick Yes or No)')
    P = models.PositiveSmallIntegerField(blank=True, null=True, choices=YES_NO, help_text='Was anyone prevented from filing an Objection to have a name deleted from the Preliminary Register of Voters (PRV) (tick Yes or No)')
    Q = models.PositiveSmallIntegerField(blank=True, null=True, choices=YES_NO, help_text='Did anyone attempt to disrupt voter registration at the centre? (tick Yes or No)')
    R = models.PositiveSmallIntegerField(blank=True, null=True, choices=YES_NO, help_text='Did anyone attempt to intimidate or harass people in or around the centre? (tick Yes or No)')

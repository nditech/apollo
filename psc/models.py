...
class DCOChecklist(models.Model):
    ...
    Q = models.PositiveSmallIntegerField(blank=True, default=0, choices=YES_NO, help_text='Did anyone attempt to disrupt voter registration at the centre? (tick Yes or No)')

...
def home(request):
    ...
    context['eday_arrived'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['arrival']['yes']).count()
    context['eday_not_arrived'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['arrival']['no']).count()
    context['eday_second_sms_missing'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['accreditation']['missing']).count()
    context['eday_second_sms_not_open_problem'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['accreditation']['problem']).count()
    context['eday_second_sms_partial'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['accreditation']['partial']).count()
    context['eday_second_sms_not_open'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['accreditation']['not_open']).count()
    context['eday_second_sms_complete'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['accreditation']['complete']).count()

    context['eday_third_sms_missing'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['voting_and_counting']['missing']).count()
    context['eday_third_sms_not_open_problem'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['voting_and_counting']['problem']).count()
    context['eday_third_sms_partial'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['voting_and_counting']['partial']).count()
    context['eday_third_sms_not_open'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['voting_and_counting']['not_open']).count()
    context['eday_third_sms_complete'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['voting_and_counting']['complete']).count()
    
    context['eday_fourth_sms_missing'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['official_summary']['missing']).count()
    context['eday_fourth_sms_not_open_problem'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['official_summary']['problem']).count()
    context['eday_fourth_sms_partial'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['official_summary']['partial']).count()
    context['eday_fourth_sms_not_open'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['official_summary']['not_open']).count()
    context['eday_fourth_sms_complete'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['official_summary']['complete']).count()
    
    context['eday_fifth_sms_missing'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['official_results']['missing']).count()
    context['eday_fifth_sms_not_open_problem'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['official_results']['problem']).count()
    context['eday_fifth_sms_partial'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['official_results']['partial']).count()
    context['eday_fifth_sms_not_open'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['official_results']['not_open']).count()
    context['eday_fifth_sms_complete'] = EDAYChecklist.objects.filter(qs).exclude(checklist_index='3').exclude(observer__role='LGA', observer__observer_id__endswith='6').filter(queries['eday']['official_results']['complete']).count()
...
def eday_checklist_list(request, action=None):
    #qs = Q(date__in=[d[0] for d in DCO_DAYS if d[0]])
    qs_include = ~Q(checklist_index='3') & ~(Q(observer__observer_id__endswith='6') & Q(observer__role='LGA'))

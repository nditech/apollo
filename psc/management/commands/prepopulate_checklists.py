    ...
    def handle(self, *args, **options):
        ...
        if len(args) and args[0] == 'vr':
            ...
            for observer in observers:
                for day in (EDAY_DAYS[1],EDAY_DAYS[3],) + EDAY_DAYS[-2:]:# This is set to remove the date for the senatorial election.
                    if day[0]:
                        report_date = day[0]
            ...
            for lga_supervisor in lga_supervisors:
                for day in EDAY_DAYS[1:4]: # omit the last two dates
                    if day[0]:
                        report_date = day[0]

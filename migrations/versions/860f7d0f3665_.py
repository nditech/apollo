...
Revision ID: 860f7d0f3665
Revises: 
Create Date: 2018-02-20 08:07:57.918436
...
def upgrade():
    ...
    sa.Column('form_type', sqlalchemy_utils.types.choice.ChoiceType(choices=models.Form.FORM_TYPES), nullable=False),
    ...
    sa.Column('gender', sqlalchemy_utils.types.choice.ChoiceType(choices=models.Participant.GENDER), nullable=True),
    sa.Column('email', sa.String(), nullable=True),
    sa.Column('deployment_id', sa.Integer(), nullable=False),
    sa.Column('participant_set_id', sa.Integer(), nullable=False),
    ...
    sa.Column('location_id', sa.Integer(), nullable=False),
    sa.Column('data', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('submission_type', sqlalchemy_utils.types.choice.ChoiceType(choices=models.Submission.SUBMISSION_TYPES), nullable=True),
    sa.Column('created', sa.DateTime(), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('direction', sqlalchemy_utils.types.choice.ChoiceType(choices=models.Message.DIRECTIONS), nullable=False),
    ...
    sa.Column('channel', sqlalchemy_utils.types.choice.ChoiceType(choices=models.SubmissionVersion.CHANNEL_CHOICES), nullable=True),
    sa.Column('deployment_id', sa.Integer(), nullable=False),

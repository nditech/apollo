...
Revision ID: f1b61a0b383b
Revises: 
Create Date: 2018-02-08 17:00:16.358225
...
from apollo.participants.rmodels import Participant
from apollo.submissions.rmodels import Submission, SubmissionVersion

# revision identifiers, used by Alembic.
revision = 'f1b61a0b383b'
down_revision = None
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('hostnames', postgresql.ARRAY(sa.String()), nullable=True),
    ...
    sa.Column('form_type', sqlalchemy_utils.types.choice.ChoiceType(Form.FORM_TYPES), nullable=True),
    ...
    sa.ForeignKeyConstraint(['deployment_id'], ['deployment.id'], ),
    sa.ForeignKeyConstraint(['group_type_id'], ['participant_group_type.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('uuid', sqlalchemy_utils.types.uuid.UUIDType(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('direction', sqlalchemy_utils.types.choice.ChoiceType(Message.DIRECTIONS), nullable=True),

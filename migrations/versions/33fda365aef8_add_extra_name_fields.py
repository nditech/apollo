...
def upgrade():
    ...
    op.add_column('participant', sa.Column('other_name_translations', postgresql.JSONB(astext_type=sa.Text()), nullable=True))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('participant', 'other_name_translations')

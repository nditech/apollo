    ...
    dashboard: function () {
        ...
        vis_setup.add(pv.Layout.Stack)
            ...
            .layer.add(pv.Bar)
                ...
                .anchor("left").add(pv.Label).textStyle(text_color).text(function(d) { return (d / checklists_status().setup.total() * 100).toFixed(1) + '%'; }).visible(function (d) { return d / checklists_status().setup.total() > 0.03;});
        ...
        vis_voting.add(pv.Layout.Stack)
            ...
            .layer.add(pv.Bar)
                .fillStyle(pv.colors(missing_color,partial_color,complete_color).by(function () { return this.parent.index; }))
                .anchor("left").add(pv.Label).textStyle(text_color).text(function(d) { return (d / checklists_status().setup.total() * 100).toFixed(1) + '%'; }).visible(function (d) { return d / checklists_status().voting.total() > 0.03;});
        ...
        vis_closing.add(pv.Layout.Stack)
            ...
            .layer.add(pv.Bar)
                .fillStyle(pv.colors(missing_color,partial_color,complete_color).by(function () { return this.parent.index; }))
                .anchor("left").add(pv.Label).textStyle(text_color).text(function(d) { return (d / checklists_status().setup.total() * 100).toFixed(1) + '%'; }).visible(function (d) { return d / checklists_status().closing.total() > 0.03;});
        ...
        vis_counting.add(pv.Layout.Stack)
            ...
            .layer.add(pv.Bar)
                .fillStyle(pv.colors(missing_color,partial_color,complete_color).by(function () { return this.parent.index; }))
                .anchor("left").add(pv.Label).textStyle(text_color).text(function(d) { return (d / checklists_status().setup.total() * 100).toFixed(1) + '%'; }).visible(function (d) { return d / checklists_status().counting.total() > 0.03;});

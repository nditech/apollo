ZambiaRouter = Backbone.Router.extend({
    ...
    dashboard: function () {
        screen = new Screen({title: 'Dashboard', contents: ''});
        screen_view = new ScreenView({model: screen, template: 'DashboardScreen'});
    },
    
    checklists: function () {
        screen = new Screen({title: 'Election Checklists', contents: ''});
   ...
   incidents: function () {
       screen = new Screen({title: 'Election Incidents', contents: ''});
       screen_view = new ScreenView({model: screen});
   },
   
   process_analysis: function () {
       screen = new Screen({title: 'Election Process Analysis', contents: ''});
       screen_view = new ScreenView({model: screen});
   },
   
   results_analysis: function () {
       screen = new Screen({title: 'Election Results Analysis', contents: ''});
       screen_view = new ScreenView({model: screen});
   },
});
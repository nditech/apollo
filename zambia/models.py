...
class ZambiaChecklistResponse(ChecklistResponse):
    ...
    AEAC = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Ballot Papers Received at Your Assigned Stream(Parliamentary )')
    AEAD = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Ballot Papers Received at Entire Polling Station(Parliamentary )')
    AEAE = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Ballot Papers Received at Your Assigned Stream(Local Government )')
    AEAF = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Ballot Papers Received at Entire Polling Station(Local Government )')
    ...
    AEBC = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Unused Ballot Papers at Your Assigned Stream(Parliamentary )')
    AEBD = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Unused Ballot Papers at Entire Polling Statio(Parliamentary n)')
    AEBE = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Unused Ballot Papers at Your Assigned Stream(Local Government )')
    AEBF = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Unused Ballot Papers at Entire Polling Station(Local Government )')
    ...
    AECC = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Issued Ballot Papers at Your Assigned Stream(Parliamentary )')
    AECD = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Issued Ballot Papers at Entire Polling Station(Parliamentary )')
    AECE = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Issued Ballot Papers at Your Assigned Stream(Local Government )')
    AECF = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Issued Ballot Papers at Entire Polling Station(Local Government )')
    ...
    AEDC = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Spoilt Ballot Papers at Your Assigned Stream(Parliamentary )')
    AEDD = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Spoilt Ballot Papers at Entire Polling Station(Parliamentary )')
    AEDE = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Spoilt Ballot Papers at Your Assigned Stream(Local Government )')
    AEDF = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Spoilt Ballot Papers at Entire Polling Station(Local Government )')
    ...
    AEEC = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Ballot Papers Found in the Ballot Box at Your Assigned Stream(Parliamentary )')
    AEED = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Ballot Papers Found in the Ballot Box at Entire Polling Station(Parliamentary )')
    AEEE = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Ballot Papers Found in the Ballot Box at Your Assigned Stream(Local Government )')
    AEEF = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Ballot Papers Found in the Ballot Box at Entire Polling Station(Local Government)')
    ...
    AFAC = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Rejected Ballot Papers at Your Assigned Stream(Parliamentary )')
    AFAD = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Rejected Ballot Papers at Entire Polling Station(Parliamentary )')
    AFAE = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Rejected Ballot Papers at Your Assigned Stream(Local Government )')
    AFAF = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Rejected Ballot Papers at Entire Polling Station(Local Government)')
    ...
    AFBC = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Disputed Ballots at Your Assigned Stream(Parliamentary )')
    AFBD = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Disputed Ballots at Entire Polling Station(Parliamentary )')
    AFBE = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Disputed Ballots at Your Assigned Stream(Local Government )')
    AFBF = models.IntegerField(blank=True, default=0, null=True, validators=[RegexValidator(r'[\d+]')], help_text='Number of Disputed Ballots at Entire Polling Station(Local Government)')

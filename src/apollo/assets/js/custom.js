...
$(function () {
    ...
    $(document).ajaxError(function () { $.facebox(Templates.ErrorDialog()); });
    ...
    $.widget("custom.catcomplete", $.ui.autocomplete, {
        _create: function () {
            ...
            this.element.after('<input type="hidden" class="search_field input_smoke persist" name="'+element_id+'" id="search_'+element_id+'" />');
    ...
    $.widget("ui.paginator", {
        ...
        _update: function () {
            var o = this.options, e = this.element, i;
            e.empty();

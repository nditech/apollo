...
urlpatterns = patterns('',
    ...
    url(r'^submissions/analysis/(?P<form>\d+)/(?P<location_id>\d+)/?$', SubmissionAnalysisView.as_view(), name='submissions_analysis_location'),
    url(r'^submissions/analysis/(?P<form>\d+)/(?P<tag>[A-Z]+)/?$', SubmissionAnalysisView.as_view(), name='submissions_analysis_tag'),
    url(r'^submissions/analysis/(?P<form>\d+)/(?P<location_id>\d+)/(?P<tag>[A-Z]+)/?$', SubmissionAnalysisView.as_view(), name='submissions_analysis_location_tag'),

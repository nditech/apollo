...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocationType.on_dashboard'
        db.add_column('core_locationtype', 'on_dashboard',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'LocationType.on_analysis'
        db.add_column('core_locationtype', 'on_analysis',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocationType.on_dashboard'
        db.delete_column('core_locationtype', 'on_dashboard')

        # Deleting field 'LocationType.on_analysis'
        db.delete_column('core_locationtype', 'on_analysis')


    models = {
        'core.activity': {
            'Meta': {'object_name': 'Activity'},
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 9, 0, 0)'}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 9, 0, 0)'})
        },
        'core.form': {

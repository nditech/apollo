...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.master'
        db.add_column('core_submission', 'master',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Submission'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.master'
        db.delete_column('core_submission', 'master_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.poly'
        db.add_column('core_location', 'poly',
                      self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.poly'
        db.delete_column('core_location', 'poly')


    models = {
        'core.activity': {
            'Meta': {'object_name': 'Activity'},
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 15, 0, 0)'}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 15, 0, 0)'})
        },
        'core.form': {
        ...
        'core.submission': {
            ...
            'data': ('djorm_hstore.fields.DictionaryField', [], {'default': '{}', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 15, 0, 0)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_activity', 'start_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 10, 0, 0)),
                      keep_default=False)

        # Adding field 'Activity.end_date'
        db.add_column('core_activity', 'end_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 10, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('core_activity', 'start_date')

        # Deleting field 'Activity.end_date'
        db.delete_column('core_activity', 'end_date')


    models = {
        'core.activity': {
            'Meta': {'object_name': 'Activity'},
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 10, 0, 0)'}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 10, 0, 0)'})
        },
        'core.form': {

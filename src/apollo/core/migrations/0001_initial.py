...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_location', (
            ...
            ('data', self.gf('djorm_hstore.fields.DictionaryField')(db_index=True, null=True, blank=True)),
        ))
        ...
        db.create_table('core_submission', (
            ...
            ('data', self.gf('djorm_hstore.fields.DictionaryField')(db_index=True, null=True, blank=True)),
            ('overrides', self.gf('djorm_hstore.fields.DictionaryField')(db_index=True, null=True, blank=True)),

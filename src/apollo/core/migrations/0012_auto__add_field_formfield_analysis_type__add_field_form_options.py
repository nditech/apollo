...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormField.analysis_type'
        db.add_column('core_formfield', 'analysis_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Form.options'
        db.add_column('core_form', 'options',
                      self.gf('djorm_hstore.fields.DictionaryField')(default='', null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormField.analysis_type'
        db.delete_column('core_formfield', 'analysis_type')

        # Deleting field 'Form.options'
        db.delete_column('core_form', 'options')


    models = {
        'core.activity': {
            'Meta': {'object_name': 'Activity'},
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 5, 0, 0)'}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 5, 0, 0)'})
        },
        'core.form': {
        ...
        'core.submission': {
            ...
            'data': ('djorm_hstore.fields.DictionaryField', [], {'default': '{}', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 5, 0, 0)'}),

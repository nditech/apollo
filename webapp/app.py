    ...
    def handle(self, message):
        ...
        if self.pattern.match(message.text):
            ...
            try:
                ...
                return message.respond('Observer ID not found. Please resend with valid Observer ID. You sent: %s' % message.message_only)
            try:
                message.location = Location.objects.get(type__code=match.group('location_type'), code=match.group('location_id'))
            except Location.DoesNotExist:
                # TODO: respond with an appropriate error message
            ...
            if (message.text.find("!") == -1): # Then it is a checklist
                ...
                try:
                    ...
                    for question_code in responses.keys():
                        if question_code not in question_codes:
                            # TODO: use a more appropriate response
                    ...
                    # TODO: use invalid_questions to construct a better response
                    ...
                    # TODO: checklist form type is invalid
                    pass
                    
            else:
                #Validating the incident question responses
                responses = list(match.group('responses'))
                ...
                try:
                    ...
                    # TODO: incident form type is invalid
                    pass
